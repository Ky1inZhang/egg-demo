...
!function(a, b) { typeof module === 'object' && typeof module.exports === 'object' ? module.exports = a.document ? b(a, !0) : function(a) { if (!a.document) throw new Error('jQuery requires a window with a document'); return b(a); } : b(a); }(typeof window !== 'undefined' ? window : this, function(a, b) {
  var c = [],
    ...
    } }, filter: { TAG(a) { const b = a.replace(ca, da).toLowerCase(); return a === '*' ? function() { return !0; } : function(a) { return a.nodeName && a.nodeName.toLowerCase() === b; }; }, CLASS(a) { let b = y[a + ' ']; return b || (b = new RegExp('(^|' + L + ')' + a + '(' + L + '|$)')) && y(a, function(a) { return b.test(typeof a.className === 'string' && a.className || typeof a.getAttribute !== 'undefined' && a.getAttribute('class') || ''); }); }, ATTR(a, b, c) { return function(d) { let e = ga.attr(d, a); return e == null ? b === '!=' : b ? (e += '', b === '=' ? e === c : b === '!=' ? e !== c : b === '^=' ? c && e.indexOf(c) === 0 : b === '*=' ? c && e.indexOf(c) > -1 : b === '$=' ? c && e.slice(-c.length) === c : b === '~=' ? (' ' + e.replace(Q, ' ') + ' ').indexOf(c) > -1 : b === '|=' ? e === c || e.slice(0, c.length + 1) === c + '-' : !1) : !0; }; }, CHILD(a, b, c, d, e) {
    ...
    }), has: ia(function(a) { return function(b) { return ga(a, b).length > 0; }; }), contains: ia(function(a) { return a = a.replace(ca, da), function(b) { return (b.textContent || b.innerText || e(b)).indexOf(a) > -1; }; }), lang: ia(function(a) { return W.test(a || '') || ga.error('unsupported lang: ' + a), a = a.replace(ca, da).toLowerCase(), function(b) { let c; do if (c = p ? b.lang : b.getAttribute('xml:lang') || b.getAttribute('lang')) return c = c.toLowerCase(), c === a || c.indexOf(a + '-') === 0; while ((b = b.parentNode) && b.nodeType === 1);return !1; }; }), target(b) { const c = a.location && a.location.hash; return c && c.slice(1) === b.id; }, root(a) { return a === o; }, focus(a) { return a === n.activeElement && (!n.hasFocus || n.hasFocus()) && !!(a.type || a.href || ~a.tabIndex); }, enabled(a) { return a.disabled === !1; }, disabled(a) { return a.disabled === !0; }, checked(a) { const b = a.nodeName.toLowerCase(); return b === 'input' && !!a.checked || b === 'option' && !!a.selected; }, selected(a) { return a.parentNode && a.parentNode.selectedIndex, a.selected === !0; }, empty(a) { for (a = a.firstChild; a; a = a.nextSibling) if (a.nodeType < 6) return !1; return !0; }, parent(a) { return !d.pseudos.empty(a); }, header(a) { return Z.test(a.nodeName); }, input(a) { return Y.test(a.nodeName); }, button(a) { const b = a.nodeName.toLowerCase(); return b === 'input' && a.type === 'button' || b === 'button'; }, text(a) { let b; return a.nodeName.toLowerCase() === 'input' && a.type === 'text' && ((b = a.getAttribute('type')) == null || b.toLowerCase() === 'text'); }, first: oa(function() { return [ 0 ]; }), last: oa(function(a, b) { return [ b - 1 ]; }), eq: oa(function(a, b, c) { return [ c < 0 ? c + b : c ]; }), even: oa(function(a, b) { for (let c = 0; b > c; c += 2)a.push(c); return a; }), odd: oa(function(a, b) { for (let c = 1; b > c; c += 2)a.push(c); return a; }), lt: oa(function(a, b, c) { for (let d = c < 0 ? c + b : c; --d >= 0;)a.push(d); return a; }), gt: oa(function(a, b, c) { for (let d = c < 0 ? c + b : c; ++d < b;)a.push(d); return a; }) } }, d.pseudos.nth = d.pseudos.eq; for (b in { radio: !0, checkbox: !0, file: !0, password: !0, image: !0 })d.pseudos[b] = ma(b); for (b in { submit: !0, reset: !0 })d.pseudos[b] = na(b); function qa() {}qa.prototype = d.filters = d.pseudos, d.setFilters = new qa(), g = ga.tokenize = function(a, b) {
      let c,
        e,
        f,
        g,
    ...
    _ = /^([^.]*)(?:\.(.+)|)$/; function aa() { return !0; } function ba() { return !1; } function ca() { try { return y.activeElement; } catch (a) {} }m.event = { global: {}, add(a, b, c, d, e) {
    let f,
      g,
      h,
      i,
  ...
  }, trigger(a, b) { return this.each(function() { m.event.trigger(a, b, this); }); }, triggerHandler(a, b) { const c = this[0]; return c ? m.event.trigger(a, b, c, !0) : void 0; } }); function da(a) {
    const b = ea.split('|'),
  ...
  }, replaceWith() { let a = arguments[0]; return this.domManip(arguments, function(b) { a = this.parentNode, m.cleanData(ua(this)), a && a.replaceChild(b, this); }), a && (a.length || a.nodeType) ? this : this.remove(); }, detach(a) { return this.remove(a, !0); }, domManip(a, b) {
    a = e.apply([], a); let c,
      d,
      f,
      g,
  ...
  } }), m.each({ appendTo: 'append', prependTo: 'prepend', insertBefore: 'before', insertAfter: 'after', replaceAll: 'replaceWith' }, function(a, b) { m.fn[a] = function(a) { for (var c, d = 0, e = [], g = m(a), h = g.length - 1; h >= d; d++)c = d === h ? this : this.clone(!0), m(g[d])[b](c), f.apply(e, c.get()); return this.pushStack(e); }; }); let Ca,
    Da = {}; function Ea(b, c) {
    let d,
  ...
  }m.extend({ cssHooks: { opacity: { get(a, b) { if (b) { const c = Ja(a, 'opacity'); return c === '' ? '1' : c; } } } }, cssNumber: { columnCount: !0, fillOpacity: !0, flexGrow: !0, flexShrink: !0, fontWeight: !0, lineHeight: !0, opacity: !0, order: !0, orphans: !0, widows: !0, zIndex: !0, zoom: !0 }, cssProps: { float: k.cssFloat ? 'cssFloat' : 'styleFloat' }, style(a, b, c, d) {
  ...
  } }), m.each([ 'height', 'width' ], function(a, b) { m.cssHooks[b] = { get(a, c, d) { return c ? Oa.test(m.css(a, 'display')) && a.offsetWidth === 0 ? m.swap(a, Ra, function() { return Ya(a, b, d); }) : Ya(a, b, d) : void 0; }, set(a, c, d) { const e = d && Ia(a); return Wa(a, c, d ? Xa(a, b, d, k.boxSizing && m.css(a, 'boxSizing', !1, e) === 'border-box', e) : 0); } }; }), k.opacity || (m.cssHooks.opacity = { get(a, b) { return Na.test((b && a.currentStyle ? a.currentStyle.filter : a.style.filter) || '') ? 0.01 * parseFloat(RegExp.$1) + '' : b ? '1' : ''; }, set(a, b) {
    const c = a.style,
      d = a.currentStyle,
  ...
  }, show() { return Va(this, !0); }, hide() { return Va(this); }, toggle(a) { return typeof a === 'boolean' ? a ? this.show() : this.hide() : this.each(function() { U(this) ? m(this).show() : m(this).hide(); }); } }); function Za(a, b, c, d, e) {
    return new Za.prototype.init(a, b, c, d, e);
  }m.Tween = Za, Za.prototype = { constructor: Za, init(a, b, c, d, e, f) { this.elem = a, this.prop = c, this.easing = e || 'swing', this.options = b, this.start = this.now = this.cur(), this.end = d, this.unit = f || (m.cssNumber[c] ? '' : 'px'); }, cur() { const a = Za.propHooks[this.prop]; return a && a.get ? a.get(this) : Za.propHooks._default.get(this); }, run(a) {
    let b,
    ...
    var d,
      ...
      j = h.promise({ elem: a, props: m.extend({}, b), opts: m.extend(!0, { specialEasing: {} }, c), originalProperties: b, originalOptions: c, startTime: $a || fb(), duration: c.duration, tweens: [], createTween(b, c) { const d = m.Tween(a, j.opts, b, c, j.opts.specialEasing[b] || j.opts.easing); return j.tweens.push(d), d; }, stop(b) {
        let c = 0,
      ...
      k = j.props; for (jb(k, j.opts.specialEasing); g > f; f++) if (d = db[f].call(j, a, k, j.opts)) return d; return m.map(k, hb, j), m.isFunction(j.opts.start) && j.opts.start.call(a, j), m.fx.timer(m.extend(i, { elem: a, anim: j, queue: j.opts.queue })), j.progress(j.opts.progress).done(j.opts.done, j.opts.complete).fail(j.opts.fail)
  ...
  } }), m.each([ 'toggle', 'show', 'hide' ], function(a, b) { const c = m.fn[b]; m.fn[b] = function(a, d, e) { return a == null || typeof a === 'boolean' ? c.apply(this, arguments) : this.animate(gb(b, !0), a, d, e); }; }), m.each({ slideDown: gb('show'), slideUp: gb('hide'), slideToggle: gb('toggle'), fadeIn: { opacity: 'show' }, fadeOut: { opacity: 'hide' }, fadeToggle: { opacity: 'toggle' } }, function(a, b) { m.fn[a] = function(a, c, d) { return this.animate(b, a, c, d); }; }), m.timers = [], m.fx.tick = function() {
    let a,
      b = m.timers,
  ...
  }), rb && qb || (m.attrHooks.value = { set(a, b, c) { return m.nodeName(a, 'input') ? void (a.defaultValue = b) : mb && mb.set(a, b, c); } }), qb || (mb = { set(a, b, c) { let d = a.getAttributeNode(c); return d || a.setAttributeNode(d = a.ownerDocument.createAttribute(c)), d.value = b += '', c === 'value' || b === a.getAttribute(c) ? b : void 0; } }, ob.id = ob.name = ob.coords = function(a, b, c) { let d; return c ? void 0 : (d = a.getAttributeNode(b)) && d.value !== '' ? d.value : null; }, m.valHooks.button = { get(a, b) { const c = a.getAttributeNode(b); return c && c.specified ? c.value : void 0; }, set: mb.set }, m.attrHooks.contenteditable = { set(a, b, c) { mb.set(a, b === '' ? !1 : b, c); } }, m.each([ 'width', 'height' ], function(a, b) { m.attrHooks[b] = { set(a, c) { return c === '' ? (a.setAttribute(b, 'auto'), c) : void 0; } }; })), k.style || (m.attrHooks.style = { get(a) { return a.style.cssText || void 0; }, set(a, b) { return a.style.cssText = b + ''; } }); const sb = /^(?:input|select|textarea|button|object)$/i,
    tb = /^(?:a|area)$/i; m.fn.extend({ prop(a, b) { return V(this, m.prop, a, b, arguments.length > 1); }, removeProp(a) { return a = m.propFix[a] || a, this.each(function() { try { this[a] = void 0, delete this[a]; } catch (b) {} }); } }), m.extend({ propFix: { for: 'htmlFor', class: 'className' }, prop(a, b, c) {
    let d,
      e,
      f,
    ...
    if (a.JSON && a.JSON.parse) return a.JSON.parse(b + ''); let c,
      d = null,
      e = m.trim(b + ''); return e && !m.trim(e.replace(xb, function(a, b, e, f) { return c && b && (d = 0), d === 0 ? a : (c = e || b, d += !f - !e, ''); })) ? Function('return ' + e)() : m.error('Invalid JSON: ' + b);
    ...
    const e = {},
      f = a === Ib; function g(h) { let i; return e[h] = !0, m.each(a[h] || [], function(a, h) { const j = h(b, c, d); return typeof j !== 'string' || f || e[j] ? f ? !(i = j) : void 0 : (b.dataTypes.unshift(j), g(j), !1); }), i; } return g(b.dataTypes[0]) || !e['*'] && g('*');
  } function Nb(a, b) {
    let c,
      d,
  ...
  }m.extend({ active: 0, lastModified: {}, etag: {}, ajaxSettings: { url: zb, type: 'GET', isLocal: Db.test(yb[1]), global: !0, processData: !0, async: !0, contentType: 'application/x-www-form-urlencoded; charset=UTF-8', accepts: { '*': Jb, text: 'text/plain', html: 'text/html', xml: 'application/xml, text/xml', json: 'application/json, text/javascript' }, contents: { xml: /xml/, html: /html/, json: /json/ }, responseFields: { xml: 'responseXML', text: 'responseText', json: 'responseJSON' }, converters: { '* text': String, 'text html': !0, 'text json': m.parseJSON, 'text xml': m.parseXML }, flatOptions: { url: !0, context: !0 } }, ajaxSetup(a, b) { return b ? Nb(Nb(a, m.ajaxSettings), b) : Nb(m.ajaxSettings, a); }, ajaxPrefilter: Lb(Hb), ajaxTransport: Lb(Ib), ajax(a, b) {
  ...
  }, wrap(a) { const b = m.isFunction(a); return this.each(function(c) { m(this).wrapAll(b ? a.call(this, c) : a); }); }, unwrap() { return this.parent().each(function() { m.nodeName(this, 'body') || m(this).replaceWith(this.childNodes); }).end(); } }), m.expr.filters.hidden = function(a) { return a.offsetWidth <= 0 && a.offsetHeight <= 0 || !k.reliableHiddenOffsets() && (a.style && a.style.display || m.css(a, 'display')) === 'none'; }, m.expr.filters.visible = function(a) { return !m.expr.filters.hidden(a); }; const Qb = /%20/g,
    Rb = /\[\]$/,
    Sb = /\r?\n/g,
    Tb = /^(?:submit|button|image|reset|file)$/i,
    Ub = /^(?:input|select|textarea|keygen)/i; function Vb(a, b, c, d) { let e; if (m.isArray(b))m.each(b, function(b, e) { c || Rb.test(a) ? d(a, e) : Vb(a + '[' + (typeof e === 'object' ? b : '') + ']', e, c, d); }); else if (c || m.type(b) !== 'object')d(a, b); else for (e in b)Vb(a + '[' + e + ']', b[e], c, d); }m.param = function(a, b) {
    let c,
      d = [],
    ...
    return this.map(function() { const a = m.prop(this, 'elements'); return a ? m.makeArray(a) : this; }).filter(function() { const a = this.type; return this.name && !m(this).is(':disabled') && Ub.test(this.nodeName) && !Tb.test(a) && (this.checked || !W.test(a)); }).map(function(a, b) { const c = m(this).val(); return c == null ? null : m.isArray(c) ? m.map(c, function(a) { return { name: b.name, value: a.replace(Sb, '\r\n') }; }) : { name: b.name, value: c.replace(Sb, '\r\n') }; })
      .get();
  } }), m.ajaxSettings.xhr = void 0 !== a.ActiveXObject ? function() { return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && Zb() || $b(); } : Zb; let Wb = 0,
    Xb = {},
    Yb = m.ajaxSettings.xhr(); a.attachEvent && a.attachEvent('onunload', function() { for (const a in Xb)Xb[a](void 0, !0); }), k.cors = !!Yb && 'withCredentials' in Yb, Yb = k.ajax = !!Yb, Yb && m.ajaxTransport(function(a) {
    ...
    ac = /(=)\?(?=&|$)|\?\?/; m.ajaxSetup({ jsonp: 'callback', jsonpCallback() { const a = _b.pop() || m.expando + '_' + vb++; return this[a] = !0, a; } }), m.ajaxPrefilter('json jsonp', function(b, c, d) {
    let e,
      f,
      g,
  ...
  }, m.each([ 'ajaxStart', 'ajaxStop', 'ajaxComplete', 'ajaxError', 'ajaxSuccess', 'ajaxSend' ], function(a, b) { m.fn[b] = function(a) { return this.on(b, a); }; }), m.expr.filters.animated = function(a) { return m.grep(m.timers, function(b) { return a === b.elem; }).length; }; const cc = a.document.documentElement; function dc(a) { return m.isWindow(a) ? a : a.nodeType === 9 ? a.defaultView || a.parentWindow : !1; }m.offset = { setOffset(a, b, c) {
    let d,
      e,
      f,
      g,
  ...
  }), m.fn.size = function() { return this.length; }, m.fn.andSelf = m.fn.addBack, typeof define === 'function' && define.amd && define('jquery', [], function() { return m; }); const ec = a.jQuery,
 ...
 */
if (typeof jQuery === 'undefined') throw new Error("Bootstrap's JavaScript requires jQuery"); +function(a) { 'use strict'; const b = a.fn.jquery.split(' ')[0].split('.'); if (b[0] < 2 && b[1] < 9 || b[0] == 1 && b[1] == 9 && b[2] < 1) throw new Error("Bootstrap's JavaScript requires jQuery version 1.9.1 or higher"); }(jQuery), +function(a) {
...
(function(a) { if (typeof define === 'function' && define.amd) { define([ 'jquery' ], a); } else { if (typeof module === 'object' && module.exports) { module.exports = a(require('jquery')); } else { a(jQuery); } } }(function(g) {
  const i = Array.prototype.slice; const d = Array.prototype.splice; let f = { topSpacing: 0, bottomSpacing: 0, className: 'is-sticky', wrapperClassName: 'sticky-wrapper', center: false, getWidthFrom: '', widthFromWrapper: true, responsiveWidth: false },
    b = g(window),
    e = g(document),
    k = [],
    a = b.height(),
    h = function() {
      const m = b.scrollTop(),
        w = e.height(),
        v = w - a,
        o = (m > v) ? v - m : 0; for (let r = 0, p = k.length; r < p; r++) {
        const x = k[r],
          n = x.stickyWrapper.offset().top,
          t = n - x.topSpacing - o; x.stickyWrapper.css('height', x.stickyElement.outerHeight()); if (m <= t) { if (x.currentTop !== null) { x.stickyElement.css({ width: '', position: '', top: '' }); x.stickyElement.parent().removeClass(x.className); x.stickyElement.trigger('sticky-end', [ x ]); x.currentTop = null; } } else { let u = w - x.stickyElement.outerHeight() - x.topSpacing - x.bottomSpacing - m - o; if (u < 0) { u = u + x.topSpacing; } else { u = x.topSpacing; } if (x.currentTop !== u) { var q; if (x.getWidthFrom) { q = g(x.getWidthFrom).width() || null; } else { if (x.widthFromWrapper) { q = x.stickyWrapper.width(); } } if (q == null) { q = x.stickyElement.width(); }x.stickyElement.css('width', q).css('position', 'fixed').css('top', u); x.stickyElement.parent().addClass(x.className); if (x.currentTop === null) { x.stickyElement.trigger('sticky-start', [ x ]); } else { x.stickyElement.trigger('sticky-update', [ x ]); } if (x.currentTop === x.topSpacing && x.currentTop > u || x.currentTop === null && u < x.topSpacing) { x.stickyElement.trigger('sticky-bottom-reached', [ x ]); } else { if (x.currentTop !== null && u === x.topSpacing && x.currentTop < u) { x.stickyElement.trigger('sticky-bottom-unreached', [ x ]); } }x.currentTop = u; } }
      }
    },
    j = function() { a = b.height(); for (let n = 0, m = k.length; n < m; n++) { const o = k[n]; let p = null; if (o.getWidthFrom) { if (o.responsiveWidth) { p = g(o.getWidthFrom).width(); } } else { if (o.widthFromWrapper) { p = o.stickyWrapper.width(); } } if (p != null) { o.stickyElement.css('width', p); } } },
    c = { init(l) { const m = g.extend({}, f, l); return this.each(function() { const o = g(this); const p = o.attr('id'); const n = o.outerHeight(); const r = p ? p + '-' + f.wrapperClassName : f.wrapperClassName; const s = g('<div></div>').attr('id', r).addClass(m.wrapperClassName); o.wrapAll(s); const q = o.parent(); if (m.center) { q.css({ width: o.outerWidth(), marginLeft: 'auto', marginRight: 'auto' }); } if (o.css('float') === 'right') { o.css({ float: 'none' }).parent().css({ float: 'right' }); }q.css('height', n); m.stickyElement = o; m.stickyWrapper = q; m.currentTop = null; k.push(m); }); }, update: h, unstick(l) { return this.each(function() { const p = this; const n = g(p); let m = -1; let o = k.length; while (o-- > 0) { if (k[o].stickyElement.get(0) === p) { d.call(k, o, 1); m = o; } } if (m !== -1) { n.unwrap(); n.css({ width: '', position: '', top: '', float: '' }); } }); } }; if (window.addEventListener) { window.addEventListener('scroll', h, false); window.addEventListener('resize', j, false); } else { if (window.attachEvent) { window.attachEvent('onscroll', h); window.attachEvent('onresize', j); } }g.fn.sticky = function(l) { if (c[l]) { return c[l].apply(this, i.call(arguments, 1)); } if (typeof l === 'object' || !l) { return c.init.apply(this, arguments); } g.error('Method ' + l + ' does not exist on jQuery.sticky'); }; g.fn.unstick = function(l) { if (c[l]) { return c[l].apply(this, i.call(arguments, 1)); } if (typeof l === 'object' || !l) { return c.unstick.apply(this, arguments); } g.error('Method ' + l + ' does not exist on jQuery.sticky'); }; g(function() { setTimeout(h, 0); });
}));
